export function sayWelcome() {
  ...
  console.log(
    `%c  Hi %cthere! Welcome to %cYelix%c${' '.repeat(
  ...
  console.log(
    `%c  I'm %cthe maintainer of this project, and if you use Yelix for an open-source project.${' '.repeat(
      characterCount -
        7 -
  ...
  console.log(
    `%c  I would %clove to review your codebase and analyze where I can improve it.${' '.repeat(
      characterCount -
        11 -
  ...
  console.log(
    `%c  Please Submit %can issue on the GitHub repository with the title "Used Yelix in my project"${' '.repeat(
      characterCount -
        17 -
  ...
  console.log(
    `%c  To not get this message %cagain, set the \`noWelcome\` option to true in the Yelix constructor.${' '.repeat(
      characterCount -
        27 -
